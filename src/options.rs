...
pub(crate) struct Options {
  ...
  #[arg(long, help = "Only index inscriptions that have a json content that contains field p with the given string.")]
  pub(crate) filter_content_json_field_p: Vec<String>,
  #[arg(
    long,
